...
//// ============ ExportSVGCommand ============
//
//std::string ExportSVGCommand::extractFilename() const {
//    validateRequiredArgument("file");
//    return getArgumentValue("file");
//}
//
//void ExportSVGCommand::execute(ISlideRepository& repository) {
//    validateAllowedArguments({ "file" });
//
//    std::string filename = extractFilename();
//
//    // Use interface - cast to ISerializableRepository
//    const ISerializableRepository* serializableRepo =
//        dynamic_cast<const ISerializableRepository*>(&repository);
//    if (!serializableRepo) {
//        throw std::runtime_error("ExportSVG command requires ISerializableRepository type");
//    }
//
//    if (Serializer::exportToSVG(*serializableRepo, filename)) {
//        std::cout << "SVG export completed successfully: " << filename << std::endl;
//    }
//    else {
//        throw std::runtime_error("Failed to export presentation to SVG");
//    }
//}
//
////void ExportSVGCommand::undo(ISlideRepository& repository) {
////    // Export operation cannot be undone
////}
